...
// ✅ يمثل هذا الكلاس بطاقة مدونة فردية في الصفحة الرئيسية ✅ This class
// represents a single "Corpora Card" on the homepage

public class HomePageCorporaCardComponent {
	...
	private final By description = By.xpath(".//p[contains(@class,'text-600')]/span");

	private final By textsIcon = By.xpath(".//img[contains(@src,'icon-documents.svg')]");
	private final By textsLabel = By
			.xpath(".//img[contains(@src,'icon-documents.svg')]/following-sibling::p[contains(@class,'text-xs')]");
	private final By textsValue = By
			.xpath(".//img[contains(@src,'icon-documents.svg')]/following-sibling::p[contains(@class,'text-700')]");

	private final By wordsIcon = By.xpath(".//img[contains(@src,'icon-words.svg')]");
	private final By wordsLabel = By
			.xpath(".//img[contains(@src,'icon-words.svg')]/following-sibling::p[contains(@class,'text-xs')]");
	private final By wordsValue = By
			.xpath(".//img[contains(@src,'icon-words.svg')]/following-sibling::p[contains(@class,'text-700')]");

	private final By uniqueIcon = By.xpath(".//img[contains(@src,'icon-words-nofreq.svg')]");
	private final By uniqueLabel = By
			.xpath(".//img[contains(@src,'icon-words-nofreq.svg')]/following-sibling::p[contains(@class,'text-xs')]");
	private final By uniqueValue = By
			.xpath(".//img[contains(@src,'icon-words-nofreq.svg')]/following-sibling::p[contains(@class,'text-700')]");

	private final By selectButton = By.xpath(".//a[.//span[text()='اختر المدونة']]");
	 ...
	 *               wait
	 */
	public HomePageCorporaCardComponent(WebElement root, WebDriver driver) {
		this.root = root;
